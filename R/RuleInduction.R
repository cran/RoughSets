...
#' @param votingScheme a function used to choose predicted values. The default value is \code{\link{X.bestFirst}}. 
#' @param ... the other parameters.
...
predict.RuleSetRST <- function(object, newdata, votingScheme = X.bestFirst, ...) {
	...
	else stop("Unrecognized classification method")
